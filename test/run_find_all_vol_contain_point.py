...
if __name__ == "__main__":
    ...
    if ret:
        ...
        exit(1)
    find_all_volume_containing_point(chp.char_point['DEFINITIONS']['ZBAA']['Lat_Long'])
    find_all_volume_containing_point(chp.char_point['DEFINITIONS']['ZSQD']['Lat_Long'])
    find_all_volume_containing_point(chp.char_point['DEFINITIONS']['ZGGG']['Lat_Long'])
